    ...
    <div>
      <div className="relative">
        ...
        <div className="p-4 absolute bottom-0  transform   text-start ">
          <h2 className="text-[#24C9FF] text-4xl lg:text-5xl font-bold">
            FREE
          </h2>
          <h3 className="text-2xl lg:text-3xl font-semibold text-white">
            IMMIGRATION CLINIC — <br />{" "}
            <span className="text-xl lg:text-2xl underline">
      ...
      <div className="bg-[#24C9FF]">
        <div className="container">
          <div className="py-5">
            <h2 className="text-base  lg:text-xl font-bold text-start text-black">
